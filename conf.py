...
BLOG_AUTHOR = "protoNN community"  # (translatable)
BLOG_TITLE = "protoNN"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://protonn-ai.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://vecto.space/"
BLOG_EMAIL = "alex@blackbird.pw"
BLOG_DESCRIPTION = "building neural nets made easy"  # (translatable)
